...
namespace JarlykMods.Hailstorm.Cataclysm
{
    public sealed class CataclysmManager
    {
        ...
        private void StageOnStart(On.RoR2.Stage.orig_Start orig, Stage self)
        {
            ...
            //Load the arena
            var arena = Object.Instantiate(CataclysmAssets.CataclysmArenaPrefab);
            ...
            RenderSettings.skybox = CataclysmAssets.CataclysmSkyboxMaterial;
            ...
            var charger1 = Object.Instantiate(CataclysmAssets.LaserChargerPrefab, folP2.transform.position, Quaternion.identity);
            var folP4 = GameObject.Find("FOL_P4");
            var charger2 = Object.Instantiate(CataclysmAssets.LaserChargerPrefab, folP4.transform.position, Quaternion.identity);
